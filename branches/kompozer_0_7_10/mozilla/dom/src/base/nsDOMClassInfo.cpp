...
static nsDOMClassInfoData sClassInfoData[] = {
  ...
  NS_DEFINE_CLASSINFO_DATA(CSSSelectorQuery, nsDOMGenericSH,
                           DOM_DEFAULT_SCRIPTABLE_FLAGS)
...
nsDOMClassInfo::Init()
{
  ...
  DOM_CLASSINFO_MAP_BEGIN(XMLDocument, nsIDOMXMLDocument)
    ...
    DOM_CLASSINFO_MAP_ENTRY(nsIDOMNSCSSSelectorQuery)
  ...
  DOM_CLASSINFO_MAP_BEGIN(CSSSelectorQuery, nsIDOMNSCSSSelectorQuery)
    DOM_CLASSINFO_MAP_ENTRY(nsIDOMNSCSSSelectorQuery)
  DOM_CLASSINFO_MAP_END
