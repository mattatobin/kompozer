  ...
  if (gDialog.expertMode) {
    ...
    if ((gDialog.selectedIndex > -1) && (gDialog.selectedTab == GENERAL_TAB)
      ...
      gDialog.cssTBox.value = 
        PrettyPrintCSS(gDialog.selectedObject.cssText, gDialog.selectedObject.href);
  }
  else {
  ...
  switch (type) {
    ...
    case PAGE_RULE:
      ...
      if (gDialog.expertMode) { // source mode (KaZcadeS)
        ...
        AddLabelToInfobox(gridrows, GetString("Selector"),
          cssObject.selectorText, null, false);
    ...
    case MEDIA_RULE:
      ...
      AddLabelToInfobox(gridrows, GetString("MediaList"),
                        cssObject.media.mediaText, null, false);
      AddLabelToInfobox(gridrows, GetString("NumberRules"),
                        cssObject.cssRules.length, null, false);
      break;
    case IMPORT_RULE:
