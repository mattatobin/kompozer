...
class nsHTMLContentSerializer : public nsXMLContentSerializer {
 ...
 protected:
  ...
  PRBool ContainsPHPChunk(const nsAString& aValueString);
  void   AppendTextInternal(const nsString&  aData, nsAString& aStr);
  PRBool IsNotMinimizable(nsIAtom * aName);
