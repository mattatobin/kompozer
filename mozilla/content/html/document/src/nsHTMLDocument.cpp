...
static const struct MidasCommand gMidasCommandTable[] = {
  ...
  { "enableabsolutepositioning", "cmd_setDocumentEnableAbsolutePositioning", "", PR_FALSE, PR_TRUE },
  { "enableobjectresizing", "cmd_setDocumentEnableObjectResizing", "", PR_FALSE, PR_TRUE },
  { "enableinlinetableediting", "cmd_setDocumentEnableInlineTableEditing", "", PR_FALSE, PR_TRUE },
#if 0
