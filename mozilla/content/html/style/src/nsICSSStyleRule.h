...
public:
  ...
  void ToDOMStringList(const nsAString & aPrefix, nsIDOMDOMStringList * aStringList);
...
public:
  ...
  void GetSelectorList(PRUint32 aSelectorFilter, nsIDOMDOMStringList *aStringList, nsICSSStyleSheet* aSheet);
...
public:
  ...
  virtual nsresult GetSelectorList(PRUint32 aSelectorFilter, nsIDOMDOMStringList * aStringList) = 0;
};
